...
<div class="container mt-5">
    ...
    <?php
        ...
        ?>
            ...
            <hr>
            <div class="result">
            <?php             echo "$g $a $f $e $h $d $g $b $f $e $h = " .$c;  ?>
            ...
            <div id="codeModal">
                ...
                <pre id="codeContent" style="font-size: 14px;">
                    <?php echo htmlspecialchars(file_get_contents('lab03-1/formula.php')); ?>
                </pre>
            </div>
            ...
            <div id="descriptionModal">
                ...
                <pre id="descriptionContent" style="font-size: 14px;">
                    <?php echo htmlspecialchars(file_get_contents('lab03-1/description.php')); ?>
                </pre>
            </div>
        ...
        <?php } else { ?>
            <h2>การหาพื้นที่สี่เหลี่ยมด้วยการคำนวณตัวเลขแบบทั่วไป</h2><hr>
