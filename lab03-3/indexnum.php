    ...
    <?php
        ...
        ?>
            ...
            <?php 
                ...
                echo "$g $e $j $a $h $d $g $e $f $b $h =". $result;
            ...
            <div id="codeModal">
                ...
                <pre id="codeContent" style="font-size: 14px;">
                    <?php echo htmlspecialchars(file_get_contents('lab03-3/formula.php')); ?>
                </pre>
            </div>
            ...
            <div id="descriptionModal">
                ...
                <pre id="descriptionContent" style="font-size: 14px;">
                    <?php echo htmlspecialchars(file_get_contents('lab03-3/description.php')); ?>
                </pre>
            </div>
        ...
        <?php } else { ?>
            <h2>การหาพื้นที่สี่เหลี่ยมด้วยการคำนวณแบบวัตถุ</h2><hr>
